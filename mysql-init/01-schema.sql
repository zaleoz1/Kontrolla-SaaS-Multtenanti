...
CREATE TABLE IF NOT EXISTS produtos (
    ...
    data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    data_atualizacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    -- Campos para estoque decimal por tipo
    estoque_kg DECIMAL(10,3) DEFAULT 0.000,
    estoque_litros DECIMAL(10,3) DEFAULT 0.000,
    estoque_minimo_kg DECIMAL(10,3) DEFAULT 0.000,
    estoque_minimo_litros DECIMAL(10,3) DEFAULT 0.000,
    FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS notificacoes (
  ...
  tipo ENUM('info', 'success', 'warning', 'error', 'venda', 'estoque', 'financeiro', 'cliente', 'sistema') NOT NULL DEFAULT 'info',
...
-- ==========================================
-- TABELAS PARA INTEGRAÇÃO MEUDANFE
-- ==========================================

-- Tabela de configurações de tenant (genérica)
...
-- Tabela de NF-e importadas via MeuDanfe
...
-- Tabela de consultas ao MeuDanfe (auditoria)
CREATE TABLE IF NOT EXISTS meudanfe_consultas (
    ...
    resultado TEXT,
    custo DECIMAL(10,4) DEFAULT 0.0300,
