...
export function GoogleLoginButton({ 
  ...
  // Use botão customizado para mobile e componente oficial para desktop
  return (
    <div className={`flex justify-center ${className}`}>
      {/* Botão customizado para mobile (sm e abaixo) */}
      <button
        type="button"
        onClick={handleGoogleLoginCustom}
        className={`sm:hidden w-full ${buttonHeight} bg-white/10 border border-white/20 text-white hover:bg-white/20 hover:border-emerald-400/50 focus:border-emerald-500 focus:ring-emerald-500/20 transition-all duration-300 rounded-md flex items-center justify-center gap-2 ${textSize} font-medium`}
      >
      ...
      {/* Componente oficial para desktop (sm e acima) */}
      <div className="hidden sm:block google-login-wrapper">
        <GoogleLogin
