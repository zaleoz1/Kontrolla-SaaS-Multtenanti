...
# Script de Deploy Rápido - KontrollaPro
# Este script automatiza todo o processo de deploy no Integrator Host
...
if [ ! -f ".env" ]; then
    ...
    sed -i "s/https:\/\/seudominio.com/https:\/\/$DOMAIN/g" .env
...
info "3. Configure seu domínio para apontar para este servidor"
info "4. Monitore os logs regularmente"
